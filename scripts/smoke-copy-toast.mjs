...
if (!/advLose: 'YOU LOSE'/.test(catalogEn)) fail('EN result.advLose must be YOU LOSE (not Dutch VERLOREN)');
if (/advLose: 'VERLOREN'/.test(catalogEn)) fail('EN result.advLose still Dutch VERLOREN');
