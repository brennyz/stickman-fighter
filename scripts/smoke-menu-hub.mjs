...
must(/id="btnPlayPrimary"/.test(menu), 'missing primary SPELEN button');
must(/id="menuLangToggle"/.test(menu), 'missing compact language chip');
must(/class="menu-more"/.test(menu), 'missing Meer overflow for Tips/Verse versie');
must(/b-play-primary/.test(css), 'missing primary play button CSS');
