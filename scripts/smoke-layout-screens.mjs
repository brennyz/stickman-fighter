...
must((/gear-filter-dock/.test(css) && /id="gearFilterDock"/.test(html))
  || (/gear-sheet-tools/.test(css) && /id="gearSheetTools"/.test(html) && /id="gearLayout"/.test(html)),
  'gear filter dock or #315 sheet tools wrapper required so chips do not stack at the same sticky top');
