...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-08-16 | **14** | **User:** speciale wapens (zone/legendary+/summon) light-FX (glow/trail/hit-flash). Plus combatEntryFor-guard na versus-retire (roster stub). v1.18.142 / SW v352. |
