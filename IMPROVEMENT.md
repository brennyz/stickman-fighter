| 2026-09-18 | **PLAYTEST BOT 6/9 telegraphs** | LIVE `c9a29fc` v1.18.190: CHARGE HUD readable; hop/fly no wind; **P1 TF-001** slime death said `vlieger →` (sticky + any-bat). Draft fix: `lastFailTele` = this hit only. Density 0.50/×1.55/batch1/gap64 **reported, not changed**. No Versus, no main. **v1.18.191 / SW 401**. |
