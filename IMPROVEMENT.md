| 2026-09-18 | **#350 DONE STOP** | P1 #338 landscape FOMO Avontuur tap frozen. Short-landscape chrome unlock only. Portrait 390 lock stays. `smoke:landscape-begin` green. **v1.18.191 / SW 401**. Draft, no main. STOP. |
| 2026-09-18 | **FOMO landscape Avontuur P1** | #338: 844×390 Vandaag dock left left Avontuur painted but `inert`/`pointer-events:none`. Short landscape skips chrome lock so Avontuur/play CTA stay tappable. Portrait 390 lock stays. `smoke:landscape-begin`. **v1.18.191 / SW 401**. Draft, no main. |
...
| 2026-09-16 | — | **Gear loot pixels + motion:** unique 16×16 (107 templates + 131-id) + rarity ring + spawn pop / 3-frame fakkel / collect snap. Gates untouched. **v1.18.168 / SW 378** draft #305. |
...
| 2026-09-14 | — | MERGE MAIN #266 → v1.18.163 / SW 373. Daarna: welcome alleen HOME, technique-banners + summons i18n. v1.18.164 / SW 374. Draft. |
