| 2026-09-18 | **#349 DONE + STOP** | TF-001 lose tip THIS killing hit only. Draft parked. No main. **v1.18.190 / SW 400**. |
| 2026-09-18 | **TF-001 lose tip THIS hit** | Sticky `lastFailTele` no longer steals an alive flyer after a Bubbel/slime kill. Cue is this killing hit only. Draft, geen main. **v1.18.190 / SW 400**. |
