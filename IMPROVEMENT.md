| 2026-09-18 | **#346 DONE** | First-kill chrome STOP. Keep KO+freeze+`banner.newDex`; drop `toast.dexDiscover`. juice-feel SMOKE_OK. Draft only, geen main. **v1.18.191 / SW 401**. |
| 2026-09-18 | **first-kill chrome** | #344: new-species KO keeps floater + freeze + `banner.newDex`; drops `toast.dexDiscover` so LEVEL/toast do not stack on the snap. Smoke juice-feel. Versus ongemoeid. Draft only. **v1.18.191 / SW 401**. |
