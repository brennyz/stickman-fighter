| 2026-09-18 | **death→retry feel** | After mega-merge: restore fat 84px Nog één keer CTA, fail-cue tip (`SLAM → Nog één keer` + `#resKiller`), keep `restartAdventureInstant`. Dock IDs untouched. **v1.18.190 / SW 400**. Draft. |
