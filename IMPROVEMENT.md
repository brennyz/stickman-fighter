...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-09-16 | — | **Gear loot pixels:** unique 16×16 silhouettes (107 templates + 131-id map) + rare/elite pickup ring/scale + cheap motion (flicker/glow/pulse, lite-off). Gates untouched. **v1.18.168 / SW 378** draft #305. |
