...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-07-25 | — | **Docs:** `SCREEN-VISIBILITY-FUNNEL.md` — stap-trechter UI vs canvas-blauw, leerlog nuclear lids, agent-werkvolgorde. Gekoppeld vanuit AGENTS + DEBUG-BLACK-SCREEN. |
