| 2026-09-14 | **seasonal BGM** | Halloween ostinato + BGM volgt #277 (`data-season-audio`, `AudioSys.seasonId`, `sf-season-change`). Geen season-UI. **v1.18.166 / SW v376**. |
| 2026-09-14 | **audio harden** | Theme-switch: soft BGM-restart, sidecar persist, geen stacked SFX, classic = raw SONGS. **v1.18.165 / SW v375**. |
