| 2026-09-18 | **FOMO HOME flush + island Continue** | #343 P2: auto-sheet after first punch waits for `#menuScreen.active` (`maybeAutoShowFomoRitual`). #338 XOR: skip auto-sheet on short landscape so Avontuur stays tappable. Verder spelen opens island until `tipsSeen.islands`. No Versus. Draft. **v1.18.191 / SW 401**. |
