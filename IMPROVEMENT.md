| 2026-09-14 | **season overlay** | CSS+story lagen (classic/jungle/halloween + winter/summer hooks). pointer-events none, persist `save.season`, Android safe-zones. Art-slots in `docs/SEASON-ASSET-SLOTS.md`. **v1.18.164 / SW v374**. |
