| 2026-09-18 | **Gear loadout first-fold** | CSS/HTML only: flat doll (no nested card), doll + 5 slots on 390 first paint, readable STAT chips, compact weapon row. Equip-look sibling owns pixel offsets. Draft, geen main. **v1.18.191 / SW 401**. speel.html. |
