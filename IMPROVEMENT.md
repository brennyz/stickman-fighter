| 2026-09-18 | **factories MM-003** | #340 LIVE `smoke:buildings-ui`: 390 wallet labeled (3×2 + `resShort`); does-lines ≤42 (drop long `desc`/`lockedWorldNamed` override); upgrade toast `Name · Lv n` (clear queue). No Versus. Draft only. **v1.18.191 / SW 401**. |
