...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-09-18 | — | **FOMO EX-021 + HUD:** Vandaag sheet compact (≤48vh) so HOME stays visible on 390px; toast vs FOMO/sub-screen chrome; welcome waits on sheet, dismisses on leave-hub, live i18n key. Draft. **v1.18.173 / SW 383**. |
