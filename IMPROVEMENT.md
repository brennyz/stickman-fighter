...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-07-26 | — | **ASSET-STYLE islands:** ontbrekende `assets/ui/island-*.svg` (7) hersteld na merge; inline `ADVENTURE_ISLANDS` → file `<img>`; SW precache + CSS img + smoke. v1.18.125 / SW v335. |
