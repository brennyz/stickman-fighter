| 2026-09-18 | **pause i18n NL** | Pause chrome follows locale: NL Gepauzeerd/Hervatten/Muziek/Geluid + status; EN/DE/FR/ES unchanged. Re-apply on pause open (`applyPauseChrome`). Monster names untouched. Layout sibling. **v1.18.191 / SW 401**. Draft. speel.html. No main. |
