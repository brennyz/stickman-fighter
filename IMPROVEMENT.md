...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-09-18 | — | **#313 DONE for sprint (P0–P2).** Geen heldere P0 over: gold primary, glance plat, idle juice uit. P3 leftover (mp4/x10/art). **v1.18.179 / SW 389**. Draft, niet main. |
