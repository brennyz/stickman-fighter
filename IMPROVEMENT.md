...
| 2026-07-25 | — | **Docs: waarom Avontuur blauw:** `DEBUG-BLACK-SCREEN.md` herschreven — menu-backdrop op canvas (#142), stale CSS (#143), `.screen` deksel, gamble-timer (#141), settings-stuck. User-vraag gedocumenteerd. |
