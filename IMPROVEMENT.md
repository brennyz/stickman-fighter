...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-07-26 | — | **ASSET-STYLE restore:** `assets/ui/` ach/lock/check/island SVGs terug + wire (`achIconSvg`/`sagaIconSvg`/`ADVENTURE_ISLANDS`); SW precache + smoke. v1.18.117 / SW v327. |
