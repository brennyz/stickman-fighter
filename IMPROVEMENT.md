| 2026-09-18 | **landscape touch #331 STOP** | DONE in code (draft). PARTIAL live browser E2E (deadline). Smokes OK. No main. **v1.18.190 / SW 400**. speel.html. |
| 2026-09-18 | **landscape touch 844×390** | 1P short-landscape pads: jump/punch right-thumb, ≥44px, 24px nav keep-out, swipe y>55%. Portrait + #321 pause gutter unchanged. Versus out. **v1.18.190 / SW 400**. Draft. speel.html. |
