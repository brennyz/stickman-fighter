...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-07-25 | **18** | Char select c5: fight-dock + summary, ready-gate, hard-distinct random duo, locked hover preview, TOT op kaarten — geen dmg-tweak. v1.18.56 / SW v266. |
