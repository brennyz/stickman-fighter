| 2026-09-14 | **buildings 1/4** | Catalog 5 quirky factories (`stick_lighter`…`echo_whistle_mill`) + save/unlock/upgrade/tick + `docs/BUILDINGS.md` bind API. Draft, **niet** main. **v1.18.164 / SW v374**. |
