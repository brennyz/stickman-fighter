| 2026-09-18 | **#355 DONE STOP** | Death+rotate pin accepted. Draft only, no main. **v1.18.191 / SW 401**. speel.html. |
| 2026-09-18 | **P1 death+rotate pin** | Playtest #336: fallen stickman vanished after portrait↔landscape. `pinDeadFighterPose` + visible letterbox floor on `pinPlayfieldBodies` / `onResize`; dead never airborne in `alignCombatPlayfield`. `smoke:death-rotate`. Draft. **v1.18.191 / SW 401**. speel.html. No main. |
