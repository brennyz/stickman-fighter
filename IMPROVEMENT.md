| 2026-08-16 | — | **Merge-fix:** versus-retire `vsRosterEntry()`=null + adventure `rosterId:'hero'` → `combatEntryFor` crash in `attackSpec`. Sla/wapen/trap-knoppen dood op mobiel. Null-check + smoke:touch-btns. v1.18.142 / SW v352. |
