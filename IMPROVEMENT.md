...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-09-18 | — | **#347 DONE:** touch `fxSpawnLite` whole fight + freeze gate. Minute-1 mid-phone elite intro still spawnLite (4 sparks, 0 freeze). `smoke:fx-lite`. Draft, geen main. **v1.18.191 / SW 401**. speel.html. |
