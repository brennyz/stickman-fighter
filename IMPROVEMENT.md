...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-07-25 | — | **Plan:** startmenu full-bleed omgeving-video + translucent UI (titel / game-tiles / meta / talen). Zie [`MENU-VIDEO-OVERHAUL.md`](./MENU-VIDEO-OVERHAUL.md). Geen code-ship. |
