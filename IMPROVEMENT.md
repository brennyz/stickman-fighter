| 2026-09-18 | **MASTERGAME first-30s** | First Avontuur: skip aim text wall until `feltFirstPunch`. One primary action = punch (`juice.strikeNudge` at 0.85s + gold pulse). FOMO/HOME landscape untouched. No Versus. Draft. **v1.18.190 / SW 400**. speel.html. |
