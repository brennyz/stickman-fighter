| 2026-09-14 | **buildings 4/4** | Powers + timed loot keyed on locked ids (`stick_lighter` … `bamboo_boesa_boiler` / `echo_whistle_mill`). Draft #290 — geen merge. **v1.18.164 / SW v374**. |
