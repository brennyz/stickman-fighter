| 2026-09-18 | **equip look hat z-order** | Gear doll stamped a T-pose baseball cap at x=0 after ready-stance lean moved the head — brim sat behind the circle. Shared Fighter+EquipLook path; new `hat` kind (brim in front); helm dome on the skull; no Versus. **v1.18.191 / SW 401**. Draft. speel.html. |
