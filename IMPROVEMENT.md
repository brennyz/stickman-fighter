| 2026-09-18 | **PLAYTEST 7/9 juice** | Draft findings only (no main): hits/KO snap pass; first-kill dex toast+banner stacks on KO (P1); RM shake/squash off, KO+freeze stay. `docs/PLAYTEST-JUICE-FEEL.md`. **v1.18.190 / SW 400**. speel.html. Versus out. |
