| 2026-09-18 | — | **pause sheet clip:** tall dex scrolls inside `#pauseRunLoot`; Resume + Quit stay on-screen ≥44px with safe-area bottom on 390×844 + 844×390. Layout only (sibling i18n). Draft **#359**. **v1.18.191 / SW 401**. speel.html. No main. |
