| 2026-09-16 | **buildings UX** | Overview → detail → upgrade sheet; one-tap resource collect; sticky 5-res wallet; `buildingDescModel`. Draft, **niet** main. **v1.18.166 / SW v376**. |
| 2026-09-14 | **buildings 1/4** | Locked 5 factories (`stick_lighter`…`echo_whistle`) · schema 1 `factories`+`wallet` · lvl 10 · rank · bind API. Draft, **niet** main. **v1.18.165 / SW v375**. |
