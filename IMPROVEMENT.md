...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-07-27 | — | **ASSET-STYLE inventaris:** na merge ontbraken `island-*.svg` weer; 7 adventure eiland-iconen hersteld + inline SVG → file `<img>` in `ADVENTURE_ISLANDS`, SW precache, CSS img-rules, smoke-menu-hub. Hub/modes/chrome/saga/ach al SVG. v1.18.128 / SW v338. |
