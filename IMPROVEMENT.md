...
| Datum (UTC) | d# | Update |
|-------------|-----|--------|
| 2026-07-26 | — | **Summons spectacle:** 5s reveal.mp4 (arena/energy/chest), ui-rail-wide stage-first layout, arcade chest (minder kinderlijk), rarity rays, smoke scale guards. Harden + merge. v1.18.117 / SW v327. |
