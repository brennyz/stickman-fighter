...
`GEAR_SLOT_IDS` · `gearItemById` · `gearGateState` · `gearEquipState` · `gearCanEquip` · `gearTooltipModel` · `gearEquipItem` · `gearSlotInventory` · `gearRenderDescriptor` · `rollGearDrop`
