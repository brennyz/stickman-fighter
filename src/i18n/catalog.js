...
function seedNlGameStrings() {
  ...
  Object.assign(I18N.nl.ui, {
    ...
    summonRevealHint: 'Tik de kist of Open — buit verschijnt in de kist',
    summonGotoWeapons: 'Naar wapens',
    summonGotoPets: 'Naar pets',
    summonCollect: 'Collectie',
    boss: 'BAAS',
    topHunter: 'Top jager',
...
const CATALOG_EN = {
  ...
  ui: {
    ...
    summonHint: 'Tap the chest to open',
    summonRevealHint: 'Tap the chest or Open — loot appears in the chest',
    summonGotoWeapons: 'To weapons',
    summonGotoPets: 'To pets',
    summonCollect: 'Collection',
    boss: 'BOSS',
