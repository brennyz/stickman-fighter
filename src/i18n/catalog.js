...
const CATALOG_FR = {
  ...
  weapon: {
    ...
    laser: { name: 'Energy blade', desc: 'Lame bleue ardente' }, fuuma: { name: 'Shuriken Fūma', desc: 'Grande étoile' },
    kristal: { name: 'Crystal blade', desc: 'Entaille d’éclats' }, donder: { name: 'Hache foudre', desc: 'Comme Lightning Pierce, en hache' },
...
const CATALOG_ES = {
  ...
  weapon: {
    ...
    laser: { name: 'Energy blade', desc: 'Filo azul ardiente' }, fuuma: { name: 'Shuriken Fūma', desc: 'Estrella grande' },
    kristal: { name: 'Hoja cristal', desc: 'Corte de fragmentos' }, donder: { name: 'Hacha rayo', desc: 'Como Lightning Pierce, pero hacha' },
    vlamzweep: { name: 'Látigo llama', desc: 'Línea de fuego' }, void: { name: 'Void claw', desc: 'Garra mítica' },
