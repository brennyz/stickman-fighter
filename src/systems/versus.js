...
const VS_SAGAS = {
  ...
  ki: { id: 'ki', label: 'Ki', blurb: 'Ki-golven & power spikes — ki vibes.' },
...
const VS_SIG_LABELS = {
  ...
  blade_arts: 'Blade arts crit',
  hitrun: 'Hit & run kicks',
  quak: 'Quak punch',
  rinne: 'Rinne technique boost',
  boss: 'Baas-crit',
  storm: 'Storm kicks',
  tank: 'Tank punch + kb',
  reach: 'Reach wapen',
...
const VS_ROSTER = [
  ...
  { id: 'ken', name: 'Ken', tag: 'Street · fire kicks', saga: 'fighter', flair: 'Red gi · blazing shoryu · combo rush',
    styleId: 'leaf_band', weapon: 'nunchaku', bodyColor: '#ff5555', gi: 'red',
    hpMul: 0.94, spdMul: 1.1, dmgMul: 1.06, crit: 0.11, critMul: 1.52, sig: 'combo', unlock: () => true, featured: true },
  { id: 'goku', name: 'Ki Hero', tag: 'Ki · melee DPS', saga: 'ki', flair: 'Orange trainee · ki-ball rush · high STR',
    styleId: 'gold', bodyColor: '#ff9a42', weapon: 'donder', special: 'spiral_orb',
  ...
  { id: 'aruskankou', name: 'Aruskankou', tag: 'Scroll · electric', saga: 'scroll', flair: 'Trainer spark · shuriken storm · crit chain',
    styleId: 'leaf_band', weapon: 'shuriken', bodyColor: '#ffe259',
    hpMul: 0.92, spdMul: 1.1, dmgMul: 1.0, crit: 0.13, critMul: 1.55, sig: 'shuriken', unlock: () => true, featured: true },
  { id: 'kutjankorio', name: 'Kutjankorio', tag: 'Scroll · fox demon', saga: 'scroll', flair: 'Red energy fox · void claw · rinne burst',
    styleId: 'fox', weapon: 'void', special: 'void_gaze', bodyColor: '#e84848',
    hpMul: 1.06, spdMul: 1.06, dmgMul: 1.12, crit: 0.11, critMul: 1.6, sig: 'void_sig', unlock: () => true, featured: true },
  { id: 'onepunchman', name: 'Cape Hero', tag: 'Cape · bald', saga: 'cape', flair: 'Bald hero · serious punch · one-hit blur',
  ...
  { id: 'rabbit', name: 'RabbitRobot', tag: 'CPU rival', saga: 'cape', flair: 'Serious bot · training rival · ear lasers',
    styleId: null, weapon: 'vuist', isRobot: true, special: 'lightning_pierce',
  ...
  { id: 'shadow', name: 'Schaduw', tag: 'Lightning Pierce', saga: 'scroll', flair: 'Lightning step · lightning_pierce charge',
    styleId: 'shadow', weapon: 'zwaard', special: 'lightning_pierce',
  ...
  { id: 'lance', name: 'Holy Lance', tag: 'Dawn · lancer', saga: 'dawn', flair: 'Sin lance · spear reach · holy thrust',
    styleId: 'samurai', weapon: 'speer', special: 'void_gaze',
    hpMul: 1.1, spdMul: 0.96, dmgMul: 1.1, crit: 0.1, critMul: 1.58, sig: 'blade_arts', unlock: () => true },
  ...
  { id: 'konoha', name: 'Leaf', tag: 'Snel', saga: 'scroll', flair: 'Leaf sprint · shuriken flurry',
    styleId: 'leaf_band', weapon: 'shuriken',
  ...
  { id: 'storm', name: 'Storm', tag: 'Bliksem', saga: 'ki', flair: 'Thunder charge · ki bolt axe',
    styleId: 'storm', weapon: 'donder', special: 'lightning_pierce',
  ...
  { id: 'samurai', name: 'Samurai', tag: 'Blade arts', saga: 'dawn', flair: 'Blade oath · crit cuts',
    styleId: 'samurai', weapon: 'zwaard',
    hpMul: 1.05, spdMul: 0.98, dmgMul: 1.08, crit: 0.09, critMul: 1.52, sig: 'blade_arts', unlock: () => true },
  { id: 'crimson_pact', name: 'Crimson', tag: 'Rinne', saga: 'dawn', flair: 'Crimson cloak · rinne pressure',
    styleId: 'crimson_pact', weapon: 'ketting', special: 'void_gaze',
    hpMul: 1.1, spdMul: 0.96, dmgMul: 1.1, crit: 0.1, critMul: 1.55, sig: 'void_sig', unlock: () => true },
  { id: 'cyber', name: 'Cyber', tag: 'Laser', saga: 'scroll', flair: 'Visor ninja · laser kunai',
    styleId: 'cyber', weapon: 'laser', special: 'lightning_pierce',
    hpMul: 0.92, spdMul: 1.06, dmgMul: 1.05, crit: 0.09, critMul: 1.52, sig: 'shuriken', unlock: () => true },
  { id: 'void', name: 'Void', tag: 'Void Gaze', saga: 'dawn', flair: 'Void sin · gravity rip',
    styleId: 'void', weapon: 'void', special: 'void_gaze',
    hpMul: 1.12, spdMul: 1.04, dmgMul: 1.14, crit: 0.12, critMul: 1.65, sig: 'void_sig', unlock: () => true },
];
