...
/** Saga-iconen als bestanden (assets/ui/saga). */
function sagaIconSvg(id) {
  const safe = encodeURIComponent(String(id || 'all'));
  return `<img class="ui-ico ui-ico--saga" src="assets/ui/saga/${safe}.svg" width="16" height="16" alt="" decoding="async">`;
}
