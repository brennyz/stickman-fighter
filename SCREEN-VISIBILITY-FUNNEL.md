...
| **D2 · Season overlay** | `#seasonOverlay` (`styles/seasons.css`) | `html[data-season]` ≠ classic | Decoratie in hoeken + wash · **`pointer-events:none`** · z-index 22 · **zichtbaar tijdens play** (safe zones) · BL/BR uit op menu/settings |
