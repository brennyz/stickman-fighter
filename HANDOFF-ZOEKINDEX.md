...
| **Touch spawnLite hold + freeze gate** | 1.18.191 | this branch | `fxSpawnLite` whole fight on touch · `fxSkipFreeze` gates kill/hit freeze · `docs/FX-LITE.md` · `smoke:fx-lite`. Versus out |
