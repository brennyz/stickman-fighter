...
| **Touch spawnLite hold + freeze gate** | 1.18.191 | #347 DONE | `fxSpawnLite` whole fight on touch · minute-1 elite still lite · `fxSkipFreeze` gates kill/hit freeze · `docs/FX-LITE.md` · `smoke:fx-lite`. Versus out |
