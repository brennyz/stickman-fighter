...
|-----------------|--------|--------|----------------|
| **Death+rotate fallen pose** | 1.18.191 | #355 DONE | `pinDeadFighterPose` · visible letterbox floor · `onResize` re-pin dead · `smoke:death-rotate`. Playtest #336. Draft, no main. Versus out. |
